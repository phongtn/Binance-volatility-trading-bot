...
if __name__ == '__main__':
    symbol = 'BNB' + 'USDT'
    start_time = int(datetime(2024, 3, 15, 0, 0, tzinfo=pytz.timezone('UTC')).timestamp() * 1000)
    end_time = int(datetime(2024, 3, 17, 0, 0, tzinfo=pytz.timezone('UTC')).timestamp() * 1000)
